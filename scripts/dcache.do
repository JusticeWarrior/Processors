...
add wave -noupdate -expand -subitemconfig {{/system_tb/DUT/CPU/CM/DCACHE/block1[1]} -expand {/system_tb/DUT/CPU/CM/DCACHE/block1[0]} -expand} /system_tb/DUT/CPU/CM/DCACHE/block1
add wave -noupdate -expand -subitemconfig {{/system_tb/DUT/CPU/CM/DCACHE/block2[1]} -expand {/system_tb/DUT/CPU/CM/DCACHE/block2[0]} -expand} /system_tb/DUT/CPU/CM/DCACHE/block2
...
add wave -noupdate -expand /system_tb/DUT/CPU/CM/DCACHE/dirty2
add wave -noupdate -expand /system_tb/DUT/CPU/CM/DCACHE/lru1
add wave -noupdate -expand /system_tb/DUT/CPU/CM/DCACHE/lru2
...
WaveRestoreCursors {{Cursor 1} {4432567 ps} 0}
...
update
WaveRestoreZoom {3212 ns} {6132 ns}
